...
\item 
void \hyperlink{namespacepyne_a901431eea411922dfec3f8cbc157c8af}{pyne\+::particle\+\_\+birth\+\_\+} (double $\ast$rands, double $\ast$x, double $\ast$y, double $\ast$z, double $\ast$e, double $\ast$w, int $\ast$c)
\item 
